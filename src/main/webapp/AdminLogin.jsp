...
if(request.getParameter("submit")!=null)
{
		...
		String QRY = "select * from tbl_admin where ";
		QRY += " username = '"+ u +"' and ";
		QRY += " password = '"+ p +"' ";
				...
				if (cn.openConn()) {
					...
					{	
						ResultSet rsUI= cn.getResultSet(QRY);
								...
								while(rsUI.next())
								{
								String userID = rsUI.getString("id");
								
							    session.setAttribute("userKey",userID);
								}
							 
					RequestDispatcher rd = request.getRequestDispatcher("Adminside.jsp");
					rd.forward(request, response);
					}else
					{ %>
						 
			            	<span>Sorry,Please Enter Right Password Or Username </span><br>
