...
<body>
	<div class="container">
		...
		<div class="content">
			<form action="SupReg.jsp" method="GET">
				<div class="user-details">
					...
					<div class="input-box">
						<span class="details">Address</span> <input type="text"
							placeholder="Enter your Address(city)"  name="txtaddress"  required>
					</div>
					<div class="input-box">
...
if(request.getParameter("submit")!=null)
{
			...
			String SQLInsert="INSERT INTO `tbl_supplier`(`sup_name`,  `password`, `email`, `contact_no`,`address`)";
			SQLInsert+="VALUES ('"+sname+"','"+password+"','"+email+"','"+pnumber+"','"+address+"')";

			String SqlDQry = "select * from tbl_supplier where ";
			SqlDQry += " sup_name = '"+ sname +"' or ";
			SqlDQry += " email = '"+ email +"' ";
				...
				try
	    		{
					...
					{	
		     			if(cn.exeQuery(SqlDQry))
		     			{
		     				...
		     				<p>*Please Select Uniq date (UserName,E-mail)</p>
		     				<%
		     			}else
		     			{		     				
							if(cn.exeUpdate(SQLInsert))
							{
								%><p>Supplier is Registed</p>
								<%			
							}else
							{
